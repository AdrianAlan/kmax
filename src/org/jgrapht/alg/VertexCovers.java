...
import org.jgrapht.util.VertexDegreeComparator;
...
public abstract class VertexCovers {
	 ...
	 * Theory and Computation, Fall 2002, Vassar College, <a href=
	 ...
	 * graphs when their edge-directions are ignored. To ignore edge directions
	 * you can use {@link org.jgrapht.Graphs#undirectedGraph(Graph)} or
